        ...
        return ( 
             ...
             <tbody > {
                this.state.Customer.map(props =>
                    <tr key = { props.id } >
                        ...
                        <td > { props.Email } </td>
                        <td >
                        <Link to = { "/Customer-Edit/" + props._id } > Edit </Link> | <a href="" onClick={() => { this.deleteCustomer(props._id) }}>Delete</a >
                        </td >
            ...
            <Link to = "/Customer-report/" >
                   ...
                   {/*  report button */}
                        ...
                        <button type="button" class="btn btn-danger" variant = "primary" > Report </button>
            </Link >
